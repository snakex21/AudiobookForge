...
UI_RUNTIME_MESSAGES = {
    ...
    "slk": {
        "llm_scan_start": "Skenovanie LLM modelov...",
        "llm_found": "Najdenych LLM modelov: {}",
        "llm_not_found": "Nenasli sa ziadne LLM modely",
        "llm_scan_error": "Chyba pri skenovani LLM modelov: {}",
        "piper_preset_missing": "Chyba definicia stahovania pre model: {}",
        "file_exists": "✓ {} uz existuje",
        "downloading": "Stahovanie {}...",
        "downloaded": "✓ {} stiahnuty",
        "download_error": "Chyba stahovania {}: {}",
        "piper_ready": "Model Piper je pripraveny: {}",
        "config_saved": "Config ulozeny",
        "old_output_removed": "Stary output.txt odstraneny - zacinam odznova",
        "done": "✓ Hotovo!",
        "error": "CHYBA: {}",
        "stopped": "Zastavene",
        "app_ready": "AudiobookForge je pripraveny.",
        "status_ready": "● PRIPRAVENE",
        "status_running": "● BEZI",
        "status_completed": "● DOKONCENE",
        "status_error": "● CHYBA",
        "status_paused": "● PAUZA",
        "status_stopped": "● ZASTAVENE",
        "pause_button": "⏸ Pauza",
        "resume_button": "▶ Pokracovat",
    },
    "slv": {
        "llm_scan_start": "Pregledovanje LLM modelov...",
        "llm_found": "Najdeni LLM modeli: {}",
        "llm_not_found": "LLM modeli niso bili najdeni",
        "llm_scan_error": "Napaka pri pregledovanju LLM modelov: {}",
        "piper_preset_missing": "Ni definicije prenosa za model: {}",
        "file_exists": "✓ {} ze obstaja",
        "downloading": "Prenos {}...",
        "downloaded": "✓ {} prenesen",
        "download_error": "Napaka pri prenosu {}: {}",
        "piper_ready": "Model Piper je pripravljen: {}",
        "config_saved": "Config shranjen",
        "old_output_removed": "Stari output.txt odstranjen - zacenjam znova",
        "done": "✓ Koncano!",
        "error": "NAPAKA: {}",
        "stopped": "Ustavljeno",
        "app_ready": "AudiobookForge je pripravljen.",
        "status_ready": "● PRIPRAVLJENO",
        "status_running": "● V TEKU",
        "status_completed": "● KONCANO",
        "status_error": "● NAPAKA",
        "status_paused": "● PAVZA",
        "status_stopped": "● USTAVLJENO",
        "pause_button": "⏸ Pavza",
        "resume_button": "▶ Nadaljuj",
    },
    "hrv": {
        "llm_scan_start": "Skeniranje LLM modela...",
        "llm_found": "Pronadeni LLM modeli: {}",
        "llm_not_found": "LLM modeli nisu pronadeni",
        "llm_scan_error": "Greska pri skeniranju LLM modela: {}",
        "piper_preset_missing": "Nema definicije preuzimanja za model: {}",
        "file_exists": "✓ {} vec postoji",
        "downloading": "Preuzimanje {}...",
        "downloaded": "✓ {} preuzet",
        "download_error": "Greska pri preuzimanju {}: {}",
        "piper_ready": "Piper model je spreman: {}",
        "config_saved": "Config spremljen",
        "old_output_removed": "Stari output.txt uklonjen - pokrecem ispocetka",
        "done": "✓ Gotovo!",
        "error": "GRESKA: {}",
        "stopped": "Zaustavljeno",
        "app_ready": "AudiobookForge je spreman.",
        "status_ready": "● SPREMNO",
        "status_running": "● RADI",
        "status_completed": "● DOVRSENO",
        "status_error": "● GRESKA",
        "status_paused": "● PAUZA",
    ...
    "cat": {
        "llm_scan_start": "Escanejant models LLM...",
        "llm_found": "Models LLM trobats: {}",
        "llm_not_found": "No s'han trobat models LLM",
        "llm_scan_error": "Error en l'escaneig dels models LLM: {}",
        "piper_preset_missing": "No hi ha definicio de descarrega per al model: {}",
        "file_exists": "✓ {} ja existeix",
        "downloading": "Descarregant {}...",
        "downloaded": "✓ {} descarregat",
        "download_error": "Error de descarrega {}: {}",
        "piper_ready": "Model Piper preparat: {}",
        "config_saved": "Config desat",
        "old_output_removed": "S'ha eliminat l'output.txt antic - començo de zero",
        "done": "✓ Fet!",
        "error": "ERROR: {}",
        "stopped": "Aturat",
        "app_ready": "AudiobookForge preparat.",
        "status_ready": "● PREPARAT",
        "status_running": "● EN EXECUCIO",
        "status_completed": "● COMPLETAT",
        "status_error": "● ERROR",
        "status_paused": "● PAUSA",
        "status_stopped": "● ATURAT",
        "pause_button": "⏸ Pausa",
        "resume_button": "▶ Repren",
    },
    "af": {
        "llm_scan_start": "Skandeer LLM-modelle...",
        "llm_found": "LLM-modelle gevind: {}",
        "llm_not_found": "Geen LLM-modelle gevind nie",
        "llm_scan_error": "Fout met skandering van LLM-modelle: {}",
        "piper_preset_missing": "Geen aflaaidefinisie vir model nie: {}",
        "file_exists": "✓ {} bestaan reeds",
        "downloading": "Laai {} af...",
        "downloaded": "✓ {} afgelaai",
        "download_error": "Aflaaifout {}: {}",
        "piper_ready": "Piper-model gereed: {}",
        "config_saved": "Config gestoor",
        "old_output_removed": "Ou output.txt verwyder - begin van voor af",
        "done": "✓ Klaar!",
        "error": "FOUT: {}",
        "stopped": "Gestop",
        "app_ready": "AudiobookForge gereed.",
        ...
        "status_error": "● FOUT",
        "status_paused": "● GEPOUSEER",
        "status_stopped": "● GESTOP",
        "pause_button": "⏸ Pouse",
        "resume_button": "▶ Hervat",
    },
    "sw": {
        "llm_scan_start": "Inachanganua modeli za LLM...",
        "llm_found": "Modeli za LLM zilizopatikana: {}",
        "llm_not_found": "Hakuna modeli za LLM zilizopatikana",
        "llm_scan_error": "Hitilafu ya uchanganuzi wa modeli za LLM: {}",
        "piper_preset_missing": "Hakuna ufafanuzi wa upakuaji kwa modeli: {}",
        "file_exists": "✓ {} tayari ipo",
        "downloading": "Inapakua {}...",
        "downloaded": "✓ {} imepakuliwa",
        "download_error": "Hitilafu ya upakuaji {}: {}",
        "piper_ready": "Modeli ya Piper iko tayari: {}",
        "config_saved": "Config imehifadhiwa",
        "old_output_removed": "output.txt ya zamani imeondolewa - ninaanza upya",
        "done": "✓ Imekamilika!",
        "error": "HITILAFU: {}",
        "stopped": "Imesimamishwa",
        "app_ready": "AudiobookForge iko tayari.",
        "status_ready": "● TAYARI",
        "status_running": "● INAENDELEA",
        "status_completed": "● IMEKAMILIKA",
        "status_error": "● HITILAFU",
        "status_paused": "● IMESITISHWA",
        "status_stopped": "● IMESIMAMISHWA",
        "pause_button": "⏸ Sitisha",
        "resume_button": "▶ Endelea",
    },
    "est": {
        "llm_scan_start": "Skannin LLM mudeleid...",
        "llm_found": "Leitud {} LLM mudelit",
        "llm_not_found": "LLM mudeleid ei leitud",
        "llm_scan_error": "LLM mudelite skannimise viga: {}",
        "piper_preset_missing": "Mudeli jaoks puudub allalaadimise maarang: {}",
        "file_exists": "✓ {} on juba olemas",
        "downloading": "Laadin {} alla...",
        "downloaded": "✓ {} alla laaditud",
        "download_error": "Allalaadimise viga {}: {}",
        "piper_ready": "Piper mudel valmis: {}",
        "config_saved": "Config salvestatud",
        "old_output_removed": "Vana output.txt eemaldatud - alustan otsast",
        "done": "✓ Valmis!",
        "error": "VIGA: {}",
        "stopped": "Peatatud",
        "app_ready": "AudiobookForge valmis.",
        "status_ready": "● VALMIS",
        "status_running": "● TOOTAB",
        "status_completed": "● LOPPETATUD",
        "status_error": "● VIGA",
        "status_paused": "● PAUSIL",
        "status_stopped": "● PEATATUD",
        "pause_button": "⏸ Paus",
        "resume_button": "▶ Jatka",
    },
    "lav": {
        "llm_scan_start": "Skene LLM modelus...",
        "llm_found": "Atrasti {} LLM modeli",
        "llm_not_found": "LLM modeli nav atrasti",
        "llm_scan_error": "LLM modelu skenesanas kluda: {}",
        "piper_preset_missing": "Modelim nav lejupielades definicijas: {}",
        "file_exists": "✓ {} jau pastav",
        "downloading": "Lejupielade {}...",
        "downloaded": "✓ {} lejupieladets",
        "download_error": "Lejupielades kluda {}: {}",
        "piper_ready": "Piper modelis gatavs: {}",
        "config_saved": "Config saglabats",
        "old_output_removed": "Vecais output.txt dzests - sak no jauna",
        "done": "✓ Gatavs!",
        "error": "KLUDA: {}",
        "stopped": "Apturets",
        "app_ready": "AudiobookForge gatavs.",
        "status_ready": "● GATAVS",
        "status_running": "● DARBOJAS",
        "status_completed": "● PABEIGTS",
        "status_error": "● KLUDA",
        "status_paused": "● PAUZE",
        "status_stopped": "● APTURETS",
        "pause_button": "⏸ Pauze",
        "resume_button": "▶ Turpinat",
    },
    "lit": {
        "llm_scan_start": "Nuskaitomi LLM modeliai...",
        "llm_found": "Rasta {} LLM modeliu",
        "llm_not_found": "LLM modeliu nerasta",
        "llm_scan_error": "LLM modeliu nuskaitymo klaida: {}",
        "piper_preset_missing": "Modeliui nera atsisiuntimo apraso: {}",
        "file_exists": "✓ {} jau yra",
        "downloading": "Atsisiunciama {}...",
        "downloaded": "✓ {} atsisiusta",
        "download_error": "Atsisiuntimo klaida {}: {}",
        "piper_ready": "Piper modelis paruostas: {}",
        "config_saved": "Config issaugotas",
        "old_output_removed": "Senas output.txt pasalintas - pradedu is naujo",
        "done": "✓ Baigta!",
        "error": "KLAIDA: {}",
        "stopped": "Sustabdyta",
        "app_ready": "AudiobookForge paruosta.",
        "status_ready": "● PARUOSTA",
        "status_running": "● VYKDOMA",
        "status_completed": "● UZBAIGTA",
        "status_error": "● KLAIDA",
        "status_paused": "● PAUZE",
...
EXTRA_UI_TEXTS = {
    ...
    "slk": {
        ...
        "import_zip_success_title": "Import ZIP",
        "export_zip_success_title": "Export ZIP",
        "import_zip_success": "Importovany config: {}\nImportovane subory Piper: {}",
        "export_zip_success": "Exportovane subory: {}",
        "import_zip_error_title": "Chyba importu ZIP",
        "export_zip_error_title": "Chyba exportu ZIP",
        "zip_missing": "ZIP neobsahuje config.json ani subory modelu Piper",
        "zip_nothing_to_export": "Nie su ziadne subory na export",
        "resume_title": "Obnovit predchadzajucu ulohu",
        "resume_message": "Vo vybranom vystupnom priecinku sa nasiel ulozeny postup pre tuto ulohu.\n\n{}\n\nAno = Obnovit\nNie = Zacat odznova\nZrusit = Zrusit",
        "overwrite_title": "Vystupny priecinok sa uz pouziva",
        "overwrite_message": "Vybrany vystupny priecinok obsahuje inu ulohu.\n\n{}\n\nAno = Prepisat staru ulohu v tomto priecinku\nNie = Zrusit a vybrat iny priecinok\nZrusit = Zrusit",
        "summary_source": "Zdroj: {}",
        "summary_mode": "Rezim: {}",
        "summary_pages": "Ulozene strany: {}",
        "summary_chunks": "Ulozene chunky: {}",
        "summary_final_audio": "Finalne audio: {}",
        "summary_elapsed": "Uplynuty cas: {}",
        "summary_stage": "Posledna faza: {}",
        "yes": "ano",
        "no": "nie",
        "recent_empty": "Zatial ziadne nedavne projekty.",
        "recent_load": "Nacitat",
        "recent_open": "Otvorit",
        "recent_source": "Zdroj: {}",
        "recent_output": "Vystup: {}",
        "recent_status_configured": "Nastavene",
        "recent_status_in_progress": "Nedokoncene",
        "recent_status_completed": "Dokoncene",
    },
    "slv": {
        "import_zip_button": "⬆ Uvozi ZIP (config + Piper)",
        "export_zip_button": "⬇ Izvozi ZIP (config + output)",
        "import_zip_title": "Uvozi ZIP",
        "export_zip_title": "Izvozi ZIP",
        "import_zip_success_title": "Uvozi ZIP",
        "export_zip_success_title": "Izvozi ZIP",
        "import_zip_success": "Uvozen config: {}\nUvozene Piper datoteke: {}",
        "export_zip_success": "Izvozene datoteke: {}",
        "import_zip_error_title": "Napaka pri uvozu ZIP",
        "export_zip_error_title": "Napaka pri izvozu ZIP",
        "zip_missing": "ZIP ne vsebuje config.json ali datotek modela Piper",
        "zip_nothing_to_export": "Ni datotek za izvoz",
        "resume_title": "Nadaljuj prejsnje opravilo",
        "resume_message": "V izbrani izhodni mapi je bil najden shranjen napredek za to opravilo.\n\n{}\n\nDa = Nadaljuj\nNe = Zacni znova\nPreklici = Preklici",
        "overwrite_title": "Izhodna mapa je ze v uporabi",
        "overwrite_message": "Izbrana izhodna mapa vsebuje drugo opravilo.\n\n{}\n\nDa = Prepisi staro opravilo v tej mapi\nNe = Preklici in izberi drugo mapo\nPreklici = Preklici",
        "summary_source": "Vir: {}",
        "summary_mode": "Nacin: {}",
        "summary_pages": "Shranjene strani: {}",
        "summary_chunks": "Shranjeni chunki: {}",
        "summary_final_audio": "Koncni audio: {}",
        "summary_elapsed": "Pretekli cas: {}",
        "summary_stage": "Zadnja faza: {}",
        "yes": "da",
        "no": "ne",
        "recent_empty": "Se ni nedavnih projektov.",
        "recent_load": "Nalozi",
        "recent_open": "Odpri",
        "recent_source": "Vir: {}",
        "recent_output": "Izhod: {}",
        "recent_status_configured": "Nastavljeno",
        "recent_status_in_progress": "Nedokoncano",
        "recent_status_completed": "Dokoncano",
    },
    "hrv": {
        "import_zip_button": "⬆ Uvezi ZIP (config + Piper)",
        "export_zip_button": "⬇ Izvezi ZIP (config + output)",
        "import_zip_title": "Uvezi ZIP",
        "export_zip_title": "Izvezi ZIP",
        "import_zip_success_title": "Uvezi ZIP",
        "export_zip_success_title": "Izvezi ZIP",
        "import_zip_success": "Uvezen config: {}\nUvezene Piper datoteke: {}",
        "export_zip_success": "Izvezene datoteke: {}",
        "import_zip_error_title": "Greska pri uvozu ZIP",
        "export_zip_error_title": "Greska pri izvozu ZIP",
        "zip_missing": "ZIP ne sadrzi config.json ni datoteke Piper modela",
        "zip_nothing_to_export": "Nema datoteka za izvoz",
        "resume_title": "Nastavi prethodni zadatak",
        "resume_message": "U odabranoj izlaznoj mapi pronaden je spremljen napredak za ovaj zadatak.\n\n{}\n\nDa = Nastavi\nNe = Pokreni ispocetka\nOdustani = Odustani",
        "overwrite_title": "Izlazna mapa je vec u upotrebi",
        "overwrite_message": "Odabrana izlazna mapa sadrzi drugi zadatak.\n\n{}\n\nDa = Prepisi stari zadatak u ovoj mapi\nNe = Odustani i odaberi drugu mapu\nOdustani = Odustani",
        "summary_source": "Izvor: {}",
        "summary_mode": "Nacin: {}",
        "summary_pages": "Spremljene stranice: {}",
        "summary_chunks": "Spremljeni chunkovi: {}",
        "summary_final_audio": "Zavrsni audio: {}",
        "summary_elapsed": "Proteklo vrijeme: {}",
        "summary_stage": "Zadnja faza: {}",
        "yes": "da",
        "no": "ne",
        "recent_empty": "Jos nema nedavnih projekata.",
        "recent_load": "Ucitaj",
        "recent_open": "Otvori",
        "recent_source": "Izvor: {}",
        "recent_output": "Izlaz: {}",
        "recent_status_configured": "Konfigurirano",
        "recent_status_in_progress": "Nedovrseno",
        "recent_status_completed": "Dovrseno",
    },
    "cat": {
        "import_zip_button": "⬆ Importa ZIP (config + Piper)",
        "export_zip_button": "⬇ Exporta ZIP (config + output)",
        "import_zip_title": "Importa ZIP",
        "export_zip_title": "Exporta ZIP",
        "import_zip_success_title": "Importa ZIP",
        "export_zip_success_title": "Exporta ZIP",
        "import_zip_success": "Config importat: {}\nFitxers Piper importats: {}",
        "export_zip_success": "Fitxers exportats: {}",
        "import_zip_error_title": "Error d'importacio ZIP",
        "export_zip_error_title": "Error d'exportacio ZIP",
        "zip_missing": "El ZIP no conte config.json ni fitxers del model Piper",
        "zip_nothing_to_export": "No hi ha fitxers per exportar",
        "resume_title": "Reprendre la tasca anterior",
        "resume_message": "S'ha trobat progres desat per a aquesta tasca a la carpeta de sortida seleccionada.\n\n{}\n\nSi = Reprendre\nNo = Comencar de nou\nCancel = Cancel",
        "overwrite_title": "La carpeta de sortida ja esta en us",
        "overwrite_message": "La carpeta de sortida seleccionada conte una altra tasca.\n\n{}\n\nSi = Sobreescriure la tasca antiga en aquesta carpeta\nNo = Cancel i triar una altra carpeta\nCancel = Cancel",
        "summary_source": "Font: {}",
        "summary_mode": "Mode: {}",
        "summary_pages": "Pagines desades: {}",
        "summary_chunks": "Chunks desats: {}",
        "summary_final_audio": "Audio final: {}",
        "summary_elapsed": "Temps transcorregut: {}",
        "summary_stage": "Ultima etapa: {}",
        "yes": "si",
        "no": "no",
        "recent_empty": "Encara no hi ha projectes recents.",
        "recent_load": "Carrega",
        "recent_open": "Obre",
        "recent_source": "Font: {}",
        "recent_output": "Sortida: {}",
        "recent_status_configured": "Configurat",
        "recent_status_in_progress": "Incomplet",
        "recent_status_completed": "Completat",
    },
    "af": {
        "import_zip_button": "⬆ Importeer ZIP (config + Piper)",
        "export_zip_button": "⬇ Voer ZIP uit (config + output)",
        "import_zip_title": "Importeer ZIP",
        "export_zip_title": "Voer ZIP uit",
        "import_zip_success_title": "Importeer ZIP",
        "export_zip_success_title": "Voer ZIP uit",
        "import_zip_success": "Config ingevoer: {}\nPiper-leers ingevoer: {}",
        "export_zip_success": "Leers uitgevoer: {}",
        "import_zip_error_title": "ZIP-invoerfout",
        "export_zip_error_title": "ZIP-uitvoerfout",
        "zip_missing": "ZIP bevat nie config.json of Piper-modelleers nie",
        "zip_nothing_to_export": "Geen leers om uit te voer nie",
        "resume_title": "Hervat vorige taak",
        "resume_message": "Gestoorde vordering vir hierdie taak is in die gekose uitvoermap gevind.\n\n{}\n\nJa = Hervat\nNee = Begin oor\nCancel = Cancel",
        "overwrite_title": "Uitvoermap is reeds in gebruik",
        "overwrite_message": "Die gekose uitvoermap bevat 'n ander taak.\n\n{}\n\nJa = Oorskryf ou taak in hierdie map\nNee = Cancel en kies 'n ander map\nCancel = Cancel",
        "summary_source": "Bron: {}",
        "summary_mode": "Modus: {}",
        "summary_pages": "Bladsye gestoor: {}",
        "summary_chunks": "Chunks gestoor: {}",
        "summary_final_audio": "Finale audio: {}",
        "summary_elapsed": "Verstreke tyd: {}",
        "summary_stage": "Laaste fase: {}",
        "yes": "ja",
        "no": "nee",
        "recent_empty": "Nog geen onlangse projekte nie.",
        "recent_load": "Laai",
        "recent_open": "Maak oop",
        "recent_source": "Bron: {}",
        "recent_output": "Uitvoer: {}",
        "recent_status_configured": "Gekonfigureer",
        "recent_status_in_progress": "Onvoltooid",
        "recent_status_completed": "Voltooi",
    },
    "sw": {
        "import_zip_button": "⬆ Ingiza ZIP (config + Piper)",
        "export_zip_button": "⬇ Hamisha ZIP (config + output)",
        "import_zip_title": "Ingiza ZIP",
        "export_zip_title": "Hamisha ZIP",
        "import_zip_success_title": "Ingiza ZIP",
        "export_zip_success_title": "Hamisha ZIP",
        "import_zip_success": "Config imeingizwa: {}\nFaili za Piper zilizoingizwa: {}",
        "export_zip_success": "Faili zilizosafirishwa: {}",
        "import_zip_error_title": "Hitilafu ya kuingiza ZIP",
        "export_zip_error_title": "Hitilafu ya kuhamisha ZIP",
        "zip_missing": "ZIP haina config.json wala faili za modeli ya Piper",
        "zip_nothing_to_export": "Hakuna faili za kuhamisha",
        "resume_title": "Endelea na kazi ya awali",
        "resume_message": "Maendeleo yaliyohifadhiwa ya kazi hii yamepatikana kwenye folda ya matokeo uliyochagua.\n\n{}\n\nNdiyo = Endelea\nHapana = Anza upya\nCancel = Cancel",
        "overwrite_title": "Folda ya matokeo tayari inatumika",
        "overwrite_message": "Folda ya matokeo uliyochagua ina kazi nyingine.\n\n{}\n\nNdiyo = Andika juu ya kazi ya zamani kwenye folda hii\nHapana = Cancel na chagua folda nyingine\nCancel = Cancel",
        "summary_source": "Chanzo: {}",
        "summary_mode": "Hali: {}",
        "summary_pages": "Kurasa zilizohifadhiwa: {}",
        "summary_chunks": "Chunks zilizohifadhiwa: {}",
        "summary_final_audio": "Audio ya mwisho: {}",
        "summary_elapsed": "Muda uliopita: {}",
        "summary_stage": "Hatua ya mwisho: {}",
        "yes": "ndiyo",
        "no": "hapana",
        "recent_empty": "Bado hakuna miradi ya karibuni.",
        "recent_load": "Pakia",
        "recent_open": "Fungua",
        "recent_source": "Chanzo: {}",
        "recent_output": "Matokeo: {}",
        "recent_status_configured": "Imesanidiwa",
        "recent_status_in_progress": "Haijakamilika",
        "recent_status_completed": "Imekamilika",
    },
    "est": {
        "import_zip_button": "⬆ Impordi ZIP (config + Piper)",
        "export_zip_button": "⬇ Ekspordi ZIP (config + output)",
        "import_zip_title": "Impordi ZIP",
        "export_zip_title": "Ekspordi ZIP",
        "import_zip_success_title": "Impordi ZIP",
        "export_zip_success_title": "Ekspordi ZIP",
        "import_zip_success": "Imporditud config: {}\nImporditud Piper failid: {}",
        "export_zip_success": "Eksporditud failid: {}",
        "import_zip_error_title": "ZIP impordi viga",
        "export_zip_error_title": "ZIP ekspordi viga",
        "zip_missing": "ZIP ei sisalda config.json faili ega Piper mudeli faile",
        "zip_nothing_to_export": "Eksportimiseks pole faile",
        "resume_title": "Jatka eelmist tood",
        "resume_message": "Valitud valjundkaustast leiti selle too salvestatud edenemine.\n\n{}\n\nJah = Jatka\nEi = Alusta otsast\nLoobu = Loobu",
        "overwrite_title": "Valjundkaust on juba kasutusel",
        "overwrite_message": "Valitud valjundkaust sisaldab teist tood.\n\n{}\n\nJah = Kirjuta selles kaustas vana too ule\nEi = Loobu ja vali teine kaust\nLoobu = Loobu",
        "summary_source": "Allikas: {}",
        "summary_mode": "Reziim: {}",
        "summary_pages": "Salvestatud lehed: {}",
        "summary_chunks": "Salvestatud chunkid: {}",
        "summary_final_audio": "Loplik audio: {}",
        "summary_elapsed": "Kulunud aeg: {}",
        "summary_stage": "Viimane etapp: {}",
        "yes": "jah",
        "no": "ei",
        "recent_empty": "Viimaseid projekte veel pole.",
        "recent_load": "Laadi",
        "recent_open": "Ava",
        "recent_source": "Allikas: {}",
        "recent_output": "Valjund: {}",
        "recent_status_configured": "Seadistatud",
        "recent_status_in_progress": "Pooleli",
        "recent_status_completed": "Valmis",
    },
    "lav": {
        "import_zip_button": "⬆ Importet ZIP (config + Piper)",
        "export_zip_button": "⬇ Eksportet ZIP (config + output)",
        "import_zip_title": "Importet ZIP",
        "export_zip_title": "Eksportet ZIP",
        "import_zip_success_title": "Importet ZIP",
        "export_zip_success_title": "Eksportet ZIP",
        "import_zip_success": "Importets config: {}\nImporteti Piper faili: {}",
        "export_zip_success": "Eksporteti faili: {}",
        "import_zip_error_title": "ZIP importa kluda",
        "export_zip_error_title": "ZIP eksporta kluda",
        "zip_missing": "ZIP nesatur config.json vai Piper modela failus",
        "zip_nothing_to_export": "Nav failu eksportam",
        "resume_title": "Turpinat ieprieksejo darbu",
        "resume_message": "Izveletaja izvades mape tika atrasts saglabats progress sim uzdevumam.\n\n{}\n\nJa = Turpinat\nNe = Sakt no jauna\nAtcelt = Atcelt",
        "overwrite_title": "Izvades mape jau tiek izmantota",
        "overwrite_message": "Izveletaja izvades mape satur citu uzdevumu.\n\n{}\n\nJa = Parsrakstit veco uzdevumu saja mape\nNe = Atcelt un izveleties citu mapi\nAtcelt = Atcelt",
        "summary_source": "Avots: {}",
        "summary_mode": "Rezims: {}",
        "summary_pages": "Saglabatas lapas: {}",
        "summary_chunks": "Saglabatie chunki: {}",
        "summary_final_audio": "Gala audio: {}",
        "summary_elapsed": "Pagajis laiks: {}",
        "summary_stage": "Pedejais posms: {}",
        "yes": "ja",
        "no": "ne",
        "recent_empty": "Vel nav neseno projektu.",
        "recent_load": "Ieladet",
        "recent_open": "Atvert",
        "recent_source": "Avots: {}",
        "recent_output": "Izvade: {}",
        "recent_status_configured": "Konfigurets",
        "recent_status_in_progress": "Nepabeigts",
        "recent_status_completed": "Pabeigts",
    },
    "lit": {
        "import_zip_button": "⬆ Importuoti ZIP (config + Piper)",
        "export_zip_button": "⬇ Eksportuoti ZIP (config + output)",
        "import_zip_title": "Importuoti ZIP",
        "export_zip_title": "Eksportuoti ZIP",
        "import_zip_success_title": "Importuoti ZIP",
        "export_zip_success_title": "Eksportuoti ZIP",
        "import_zip_success": "Importuotas config: {}\nImportuoti Piper failai: {}",
        "export_zip_success": "Eksportuoti failai: {}",
        "import_zip_error_title": "ZIP importo klaida",
        "export_zip_error_title": "ZIP eksporto klaida",
        "zip_missing": "ZIP faile nera config.json arba Piper modelio failu",
        "zip_nothing_to_export": "Nera failu eksportui",
        "resume_title": "Testi ankstesni darba",
        "resume_message": "Pasirinktame isvesties aplanke rastas issaugotas sio darbo progresas.\n\n{}\n\nTaip = Testi\nNe = Pradeti is naujo\nAtsaukti = Atsaukti",
        "overwrite_title": "Isvesties aplankas jau naudojamas",
        "overwrite_message": "Pasirinktame isvesties aplanke yra kitas darbas.\n\n{}\n\nTaip = Perasyti sena darba siame aplanke\nNe = Atsaukti ir pasirinkti kita aplanka\nAtsaukti = Atsaukti",
        "summary_source": "Saltinis: {}",
        "summary_mode": "Rezimas: {}",
        "summary_pages": "Issaugota puslapiu: {}",
        "summary_chunks": "Issaugota chunku: {}",
        "summary_final_audio": "Galutinis audio: {}",
        "summary_elapsed": "Praejes laikas: {}",
        "summary_stage": "Paskutinis etapas: {}",
        "yes": "taip",
        "no": "ne",
        "recent_empty": "Naujausiu projektu dar nera.",
        "recent_load": "Ikelti",
        "recent_open": "Atverti",
        "recent_source": "Saltinis: {}",
        "recent_output": "Isvestis: {}",
        "recent_status_configured": "Sukonfiguruota",
        "recent_status_in_progress": "Nebaigta",
        "recent_status_completed": "Uzbaigta",
    },
}
